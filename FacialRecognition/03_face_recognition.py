...
# names = ['None', 'Nikhil', 'Himani', 'ishika', 'Vaishnavi'] 
    ...
    for(x,y,w,h) in faces:
        ...
        if(profile!=None):
            if (int(conf) < 50):
                ...
                cv2.putText(im,str(profile[1]), (x+2,y+h+30),font, 1, (255,255,255), 2)
    
            else:
                id = "unknown"
                conf = "  {0}%".format(round(100 - conf))
                cv2.putText(im,str(id), (x+2,y+h+30),font, 1, (255,255,255), 2)
    cv2.imshow('im',im) 
